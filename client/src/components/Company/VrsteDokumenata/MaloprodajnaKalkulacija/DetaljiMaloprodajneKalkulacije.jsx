...
const PDFMaloprodajneKalkulacije = lazy(() => import("../../PDFLayout/PDFMaloprodajnaKalkulacija.jsx")) ;
...
const DetaljiMaloprodajneKalkulacije = ({ dokumentId, poslovniceId }) => {
...
export default DetaljiMaloprodajneKalkulacije;